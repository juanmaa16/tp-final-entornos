...
function pie() {
    ...
    <div id="footer"> 
        <br />
        <br />
        2014- Rosario, Santa Fe, Argentina. <br/> <p title="Zelko Karina, Gonzalez Araceli, Viscusso Sebastian, Ortiz Juan Manuel.">Desarrolladores</p> 
    </div>
<?php }
?>
...
function menuInstitucion() {
    if ($_SESSION['id_institucion'] != NULL) {
        ?>
        <div id="menu">
            <ul id="css3menu1" class="topmenu">
                <li class="topmenu"><a href="carreras.php" style="width:179px;height:28px;line-height:28px;"><span>CARRERAS</span></a></li>
                <li class="topmenu"><a href="institucion_modifica.php?id=<?php echo $_SESSION['id_institucion']?>" style="width:178px;height:28px;line-height:28px;">INSTITUCION</a></li>
                <li class="toplast"><a href="contacto.php" style="width:179px;height:28px;line-height:28px;">CONTACTO</a></li>
            </ul>
        </div>
    <?php
